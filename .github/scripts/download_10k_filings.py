#!/usr/bin/env python3
"""
Download 10-K filings from SEC EDGAR using datamule.
Targets filings containing Item 106 and Item 407(j) (Cybersecurity Risk Management & Governance).
"""
...
def download_10k_filings(start_date: str, end_date: str, output_dir: str, use_provider: bool):
    ...
    try:
        ...
        print(f"Downloaded {len(files)} 10-K filing files.")
        return len(files)
        ...
        print(f"ERROR downloading 10-K filings: {e}")
        raise
